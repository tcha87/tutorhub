...
class="wrapper"><div
class="register-column register-form"><h1 class="register-step-title">Sign up</h1><p
...
class="form-wrapper">
<a
class="facebook-connect"  style="display:block" data-href="#" href="#" onclick="window.open('https://www.facebook.com/v2.4/dialog/oauth?client_id=1682189642092945&state=fefd426f191649b776a537dae97ac689&response_type=code&sdk=php-sdk-5.0.0&redirect_uri=http%3A%2F%2Fwww.superprof.co.uk%2Ffb-connect.php%3Fid_annonce%3D&scope=public_profile%2Cemail%2Cuser_location%2Cuser_birthday&display=popup', 'FBlogin', 'width=520, height=600');return false;">Register with Facebook</a>
<span
...
class="register-column connection-form hide"><h1 class="register-step-title">Login</h1><form
action="" method="POST" class="component-form"><div
class="form-wrapper">
<a
class="facebook-connect" style="display:block" href="#" onclick="window.open('https://www.facebook.com/v2.4/dialog/oauth?client_id=1682189642092945&state=fefd426f191649b776a537dae97ac689&response_type=code&sdk=php-sdk-5.0.0&redirect_uri=http%3A%2F%2Fwww.superprof.co.uk%2Ffb-connect.php%3Fid_annonce%3D&scope=public_profile%2Cemail%2Cuser_location%2Cuser_birthday&display=popup', 'FBlogin', 'width=520, height=600');return false;">Sign in with Facebook</a>
<span
class="text-separator">or</span><div
class="input-text input-container">
<input
...
href="register-form" class="register-member-link popin-link" data-target="popin-forget-password">Forgot password?</a></p></div></form></div></div></div>




</div><divclass="notification valid hidden" id="errorNotification" data-timeout="15000"><div
class="wrapper"><p
